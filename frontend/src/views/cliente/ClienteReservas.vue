    ...
    <div class="lg:ml-64 transition-all duration-300">
      <div class="max-w-6xl mx-auto p-6 text-white">
          ...
          <div class="bg-gray-800 p-4 rounded-lg">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold">{{ reservas.length }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-800 p-4 rounded-lg">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-green-400">{{ reservasCompletadas }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-800 p-4 rounded-lg">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-purple-400">${{ totalGastado.toLocaleString() }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="reservas.length === 0" class="text-center py-12">
          ...
          <h3 class="mt-2 text-sm font-medium text-gray-300">No tienes reservas</h3>
            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                <div class="flex items-center mb-3">
                  <h3 class="text-lg font-semibold text-white">Reserva #{{ reserva.id }}</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p class="text-white">📍 {{ reserva.origen }}</p>
                  </div>
                  <div>
                    <p class="text-sm text-gray-400 mb-1">Destino</p>
                    <p class="text-white">📍 {{ reserva.destino }}</p>
                  </div>
                  <div>
                    <p class="text-sm text-gray-400 mb-1">Precio</p>
                    <p class="text-white font-semibold">${{ reserva.precio.toLocaleString() }} CLP</p>
                  </div>
                  <div>
                    <p class="text-sm text-gray-400 mb-1">Fecha</p>
                    <p class="text-white">📅 {{ formatDate(reserva.fecha) }}</p>
                  </div>
                </div>
