...
const currentUrl = `${siteUrl}/transporte-en-frio-santiago`
...
const faqs = computed(() => {
  ...
  return Array.from({ length: 18 }, (_, i) => ({
    question: t(`pages.transporteFrio.faqs.faq${i + 1}.question`),
    answer: t(`pages.transporteFrio.faqs.faq${i + 1}.answer`),
    open: o[i]
  }))
})
</script>
