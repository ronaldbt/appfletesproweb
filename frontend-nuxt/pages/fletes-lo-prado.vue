<template>
  <FletesComunaLayout :hero="content.hero">
    ...
    <section class="py-16 md:py-20 bg-white" id="faqs">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6 pb-3 border-b-4 border-teal-500 w-fit">Preguntas frecuentes: fletes Lo Prado</h2>
        <ul class="space-y-6">
...
<script setup>
import content from '~/data/comunas/lo-prado.js'

const siteUrl = 'https://fletespro.cl'
const routeSlug = 'lo-prado'
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Fletes Lo Prado', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Fletes y mudanzas en Lo Prado',
  name: 'Fletes Lo Prado',
  ...
  areaServed: { '@type': 'City', name: 'Lo Prado', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
