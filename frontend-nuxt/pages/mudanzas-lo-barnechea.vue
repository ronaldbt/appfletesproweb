<template>
  <FletesComunaLayout :hero="content.hero">
    ...
    <section class="py-16 md:py-20 bg-white" id="faqs">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6 pb-3 border-b-4 border-teal-500 w-fit">Preguntas frecuentes: mudanzas Lo Barnechea</h2>
        <ul class="space-y-6">
...
<script setup>
import content from '~/data/mudanzas/lo-barnechea.js'

const comunaName = 'Lo Barnechea'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-lo-barnechea`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas Lo Barnechea', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en Lo Barnechea',
  name: 'Mudanzas Lo Barnechea',
  ...
  provider: {
    ...
    address: { '@type': 'PostalAddress', addressLocality: 'Lo Barnechea', addressRegion: 'Región Metropolitana', addressCountry: 'CL' },
  ...
  areaServed: { '@type': 'City', name: 'Lo Barnechea', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
