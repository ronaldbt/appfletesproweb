...
<script setup>
import content from '~/data/mudanzas/la-reina.js'

const comunaName = 'La Reina'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-la-reina`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas La Reina', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en La Reina',
  name: 'Mudanzas La Reina',
