...
<script setup>
import content from '~/data/mudanzas/san-miguel.js'

const comunaName = 'San Miguel'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-san-miguel`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas San Miguel', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en San Miguel',
  name: 'Mudanzas San Miguel',
