...
<script setup>
import content from '~/data/mudanzas/providencia.js'

const comunaName = 'Providencia'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-providencia`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas Providencia', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en Providencia',
  name: 'Mudanzas Providencia',
