...
<script setup>
import content from '~/data/mudanzas/la-cisterna.js'

const comunaName = 'La Cisterna'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-la-cisterna`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas La Cisterna', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en La Cisterna',
  name: 'Mudanzas La Cisterna',
  ...
  provider: {
    ...
    address: { '@type': 'PostalAddress', addressLocality: 'La Cisterna', addressRegion: 'Región Metropolitana', addressCountry: 'CL' },
  ...
  areaServed: { '@type': 'City', name: 'La Cisterna', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
