  ...
  <FletesComunaLayout :hero="content.hero">
    <section class="py-16 md:py-20 bg-white border-t border-slate-100">
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <p class="text-slate-600 leading-relaxed mb-10">{{ content.precios.p2 }}</p>
      </div>
    </section>
    ...
    <section class="py-16 md:py-20 bg-white" id="faqs">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6 pb-3 border-b-4 border-teal-500 w-fit">Preguntas frecuentes: fletes La Granja</h2>
        <ul class="space-y-6">
...
<script setup>
import content from '~/data/comunas/la-granja.js'

const siteUrl = 'https://fletespro.cl'
const routeSlug = 'la-granja'
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Fletes La Granja', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Fletes y mudanzas en La Granja',
  name: 'Fletes La Granja',
  ...
  areaServed: { '@type': 'City', name: 'La Granja', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
