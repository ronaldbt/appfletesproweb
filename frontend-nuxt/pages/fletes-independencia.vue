  ...
  <FletesComunaLayout :hero="content.hero">
    <section class="py-16 md:py-20 bg-white border-t border-slate-100">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-4 pb-3 border-b-4 border-teal-500 w-fit">
          {{ content.precios.h2 }}
        </h2>
      ...
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="space-y-6">
          <article
            ...
            :key="i"
            class="bg-teal-50/50 rounded-r-2xl border-l-4 border-teal-500 p-6 pl-6"
          >
    ...
    <section class="py-16 md:py-20 bg-teal-50/30">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6 pb-3 border-b-4 border-teal-500 w-fit">
          {{ content.h2Ventajas }}
        </h2>
    ...
    <section class="py-16 md:py-20 bg-white" id="faqs">
      <div class="container mx-auto px-4 max-w-4xl">
        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6 pb-3 border-b-4 border-teal-500 w-fit">
          Preguntas frecuentes: fletes Independencia
        </h2>
        <ul class="space-y-6">
...
<script setup>
import content from '~/data/comunas/independencia.js'

const siteUrl = 'https://fletespro.cl'
const routeSlug = 'independencia'
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Fletes Independencia', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Fletes y mudanzas en Independencia',
  name: 'Fletes Independencia',
  ...
  areaServed: { '@type': 'City', name: 'Independencia', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
