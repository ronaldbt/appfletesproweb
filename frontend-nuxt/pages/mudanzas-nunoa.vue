...
<script setup>
import content from '~/data/mudanzas/nunoa.js'

const comunaName = 'Ñuñoa'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-nunoa`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas Ñuñoa', item: currentUrl }
  ]
}
...
const serviceSchema = {
  ...
  provider: {
    ...
    address: { '@type': 'PostalAddress', addressLocality: 'Ñuñoa', addressRegion: 'Región Metropolitana', addressCountry: 'CL' },
