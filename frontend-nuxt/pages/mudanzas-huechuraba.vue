...
<script setup>
import content from '~/data/mudanzas/huechuraba.js'

const comunaName = 'Huechuraba'
const siteUrl = 'https://fletespro.cl'
const currentUrl = `${siteUrl}/mudanzas-huechuraba`
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Mudanzas Huechuraba', item: currentUrl }
  ]
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Mudanzas en Huechuraba',
  name: 'Mudanzas Huechuraba',
  ...
  provider: {
    ...
    address: { '@type': 'PostalAddress', addressLocality: 'Huechuraba', addressRegion: 'Región Metropolitana', addressCountry: 'CL' },
  ...
  areaServed: { '@type': 'City', name: 'Huechuraba', containedInPlace: { '@type': 'AdministrativeArea', name: 'Región Metropolitana' } }
}
