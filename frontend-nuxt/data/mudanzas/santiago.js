...
export default {
  ...
  hero: {
    ...
    title: 'Mudanzas en Santiago',
    intro: 'Mudanzas en Santiago y toda la Región Metropolitana. Cotiza con la calculadora o por WhatsApp. Presupuesto gratis. Cobertura en Providencia, Las Condes, Ñuñoa, Maipú, Vitacura y las 52 comunas de la RM.',
    introExtra: 'Somos una empresa de mudanzas en Santiago: servicio de mudanzas Santiago centro y toda la RM, con ayudantes, camión de mudanza adecuado y asesoría para el salvoconducto. Mudanzas dentro de Santiago y mudanzas en Santiago Chile a regiones.'
  },
  precios: {
    h2: 'Precios de mudanzas en Santiago',
    intro: 'El costo de tu mudanza depende de la distancia, el volumen de carga y si necesitas ayudantes. Cotizamos en función del recorrido real entre origen y destino.',
    ...
    p3: 'Ofrecemos mudanzas baratas y mudanzas económicas Santiago; el precio depende del recorrido y del volumen. Si quieres una referencia del camión de mudanza Santiago precio para tu mudanza, usa la calculadora o escríbenos por WhatsApp.'
  },
  rutas: {
  ...
  servicios: {
    ...
    items: [
      ...
      { h3: 'Mudanzas a regiones', text: 'Rutas Santiago–Valparaíso, Santiago–Concepción, Santiago–sur y norte. Presupuesto según distancia.' }
    ],
  ...
  faqs: [
    {
      ...
      answer: 'El precio depende de la distancia (origen–destino), el volumen de carga y si necesitas ayudantes. Usa la calculadora de esta página para una estimación. Mudanzas dentro de Santiago suelen partir desde los $40.000 según la ruta.'
    },
    {
      question: '¿Necesito salvoconducto para mudarme en Santiago?',
      answer: 'Sí. En Chile es obligatorio tramitar un salvoconducto de mudanza en notaría (o Carabineros en casos especiales) antes del traslado. Sin él, Carabineros puede detener el camión y aplicar multas. Tramítalo 2 a 5 días antes de la mudanza.'
    },
    {
      question: '¿Hacen mudanzas a regiones desde Santiago?',
      answer: 'Sí. Cubrimos rutas Santiago–Valparaíso, Santiago–Viña del Mar, Santiago–Concepción y otras regiones. El precio se calcula según la distancia. Escríbenos por WhatsApp con origen y destino para un presupuesto.'
    },
    {
    ...
    {
      question: '¿Hacen mudanzas baratas en Santiago de Chile?',
      answer: 'Sí. Ofrecemos mudanzas baratas Santiago y mudanzas económicas Santiago; el valor depende de la ruta y del tamaño de tu mudanza. Las mudanzas dentro de Santiago suelen ser más económicas que las que van a otras regiones. Somos una empresa de mudanzas en Santiago con precios transparentes: cotiza con la calculadora o por WhatsApp para mudanzas en Santiago Chile y mudanzas chile Santiago con presupuesto claro.'
    }
  ]
}
